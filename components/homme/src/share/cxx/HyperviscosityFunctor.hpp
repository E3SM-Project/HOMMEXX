...
public:
  ...
  ExecViewManaged<Scalar *    [NP][NP][NUM_LEV]>  m_dptens;
  ExecViewManaged<Scalar * [2][NP][NP][NUM_LEV]>  m_vtens;
  ...
  void operator()(const TagFetchStates&, const int idx) const
  {
    ...
    m_dptens(ie,m_itl,  igp,jgp,ilev) = m_elements.m_dp3d(ie,m_itl,  igp,jgp,ilev);
    m_ttens (ie,m_itl,  igp,jgp,ilev) = m_elements.m_t   (ie,m_itl,  igp,jgp,ilev);
    m_vtens (ie,m_itl,0,igp,jgp,ilev) = m_elements.m_v   (ie,m_itl,0,igp,jgp,ilev);
    m_vtens (ie,m_itl,1,igp,jgp,ilev) = m_elements.m_v   (ie,m_itl,1,igp,jgp,ilev);
  }
  ...
  void operator()(const TagApplyInvMass&, const int idx) const
  {
    ...
    m_dptens(ie,m_itl,  igp,jgp,ilev) *= m_elements.m_rspheremp(ie,igp,jgp);
    m_ttens (ie,m_itl,  igp,jgp,ilev) *= m_elements.m_rspheremp(ie,igp,jgp);
    m_vtens (ie,m_itl,0,igp,jgp,ilev) *= m_elements.m_rspheremp(ie,igp,jgp);
    m_vtens (ie,m_itl,1,igp,jgp,ilev) *= m_elements.m_rspheremp(ie,igp,jgp);
  }
