  ...
  void operator() (TeamMember team) const
  {
    ...
    Kokkos::parallel_for (
      ...
      [&] (const int lev_q)
      {
        ...
        ExecViewUnmanaged<Scalar[NP][NP][NUM_LEV]>       q_buf = Homme::subview(m_region.buffers.qtens,kv.ie,iq);
        ExecViewUnmanaged<Scalar[2][NP][NP][NUM_LEV]>    v_buf = Homme::subview(m_region.buffers.vstar_qdp,kv.ie,iq);
        ...
        Kokkos::parallel_for (
          ...
          [&] (const int idx)
          {
            ...
            v_buf(0,igp,jgp,kv.ilev) = m_region.buffers.vstar(kv.ie,0,igp,jgp,kv.ilev) * qdp(igp,jgp,kv.ilev);
            v_buf(1,igp,jgp,kv.ilev) = m_region.buffers.vstar(kv.ie,1,igp,jgp,kv.ilev) * qdp(igp,jgp,kv.ilev);
