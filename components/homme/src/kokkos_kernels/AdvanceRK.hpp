...
public:
  ...
  using SharedView = Kokkos::View< Scalar[NP][NP], Kokkos::LayoutLeft, SharedSpace, Kokkos::MemoryUnmanaged>;

  // TODO set up views
  AdvanceRK( Dinv   arg_elem_dinv
           , Deriv  arg_elem_deriv
           , P      arg_elem_p
           , PS     arg_elem_ps
           , GradPS arg_elem_gradps
           , V      arg_elem_v
           , Det    arg_elem_metdet
           )
