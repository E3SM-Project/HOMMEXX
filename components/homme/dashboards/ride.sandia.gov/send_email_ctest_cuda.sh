...
/bin/mail -s "HOMMEXX (master, CUDA KokkosNode): $TT tests passed, $TTT tests failed, $TTTT tests not run, $TTTTT timeouts" "ikalash@sandia.gov, agsalin@sandia.gov, onguba@sandia.gov, mdeakin@sandia.gov, dsunder@sandia.gov, lbertag@sandia.gov" < /home/ikalash/nightlyHOMMEXXCDash/results_hommexx_cuda
