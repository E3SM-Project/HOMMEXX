...
bash -c -l "source skybridge_modules_gcc.sh >& modules_trilinos.out; bash nightly_cron_script_trilinos_skybridge_serial.sh"
bash -c -l "source skybridge_modules_gcc.sh >& modules_hommexx.out; bash nightly_cron_script_hommexx_skybridge_serial.sh" 
