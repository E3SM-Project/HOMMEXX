...
echo "The HOMMEXX CDash site can be accessed here: http://cdash.sandia.gov/CDash-2-3-0/index.php?project=HOMMEXX (SRN) and http://my.cdash.org/index.php?project=HOMMEXX (SON)." >> results5
echo "" >> results5
