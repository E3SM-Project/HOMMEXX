...
void gradient_sphere_f90   (CF90Ptr& scalar_f90, CF90Ptr& DInv_f90, F90Ptr& vector_f90, const int& nelems);
void divergence_sphere_f90 (CF90Ptr& vector_f90, CF90Ptr& DInv_f90, CF90Ptr& metdet_f90, F90Ptr& scalar_f90, const int& nelems);
void vorticity_sphere_f90  (CF90Ptr& vector_f90, CF90Ptr& D_f90, CF90Ptr& metdet_f90, F90Ptr& scalar_f90, const int& nelems);
...
TEST_CASE ("SphereOperators", "Testing spherical differential operators")
{
  ...
  ExecViewManaged<Real*[2][NP][NP]>    vector_cxx_exec("vector_cxx_exec",nelems);
  ...
  SECTION ("divergence sphere")
  {
    ...
    for (int itest=0; itest<num_rand_test; ++itest)
    {
      ...
      // Compute f90
      divergence_sphere_f90 (vector_f90, DInv_f90, metdet_f90, scalar_f90, nelems);
