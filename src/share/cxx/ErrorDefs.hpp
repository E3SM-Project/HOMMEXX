...
template <typename T>
void option_error(const std::string &location, const std::string &option,
                  const T &value) {
  std::stringstream msg;
  msg << "Error in " << location << ": "
      << "unsupported value '" << value << "' for input parameter '" << option
      << "'.";
...
template <typename T>
void check_option(const std::string &location, const std::string &option,
...
void check_option(const std::string &location, const std::string &option,
  ...
  if (bad_inputs) {
    ...
    msg << "Error in " << location << ": "
        << "unsupported value '" << value << "' for input parameter '" << option
        << "'.\n"
        << " The value should satisfy " << option << " "
        << cmp_str[etoi(relation)] << " " << ref_value << ".";
...
void check_options_relation(const std::string &location,
                            ...
                            const std::string &option2, const T1 &value1,
                            const T2 &value2, const ComparisonOp &relation) {
  bool bad_inputs = false;
  switch (relation) {
    case ComparisonOp::EQ:
      if (value1 != value2) {
  ...
  if (bad_inputs) {
    ...
    std::stringstream msg;
    msg << "Error in " << location << ": "
        << "unsupported combination for input parameters '" << option1 << "' ("
        << value1 << ") and '" << option2 << "' (" << value2 << ").\n"
        << " The two should satisfy " << option1 << " "
        << cmp_str[etoi(relation)] << " " << option2 << ".";
