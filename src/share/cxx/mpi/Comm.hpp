...
class Comm {
 public:
  // The default comm creates a wrapper to MPI_COMM_SELF, rather than
  // MPI_COMM_WORLD, because it is safer to assume I'm the only proc in the comm
  // rather than assuming that the whole world is in my group.
  Comm();
